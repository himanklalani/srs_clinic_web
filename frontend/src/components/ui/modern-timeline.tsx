...
// Use the renamed shadcn-card instead of 'card' to prevent case conflict
                ...
                <div className="flex items-start gap-4 sm:gap-6">
                  <div className="relative flex-shrink-0">
                    <motion.div
                      ...
                      tabIndex={0}
                      role="img"
                      aria-label={`Step for ${item.title}`}
                    >
                      <div className={cn(
                        "w-12 h-12 sm:w-16 sm:h-16 rounded-xl overflow-hidden border-2 border-background shadow-lg relative z-10 flex items-center justify-center transition-colors duration-300",
