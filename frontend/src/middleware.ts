...
export function middleware(request: NextRequest) {
  ...
  const rawBookingApiUrl = process.env.NEXT_PUBLIC_BOOKING_API_URL || 'https://review-booking-system.onrender.com';
  let bookingApiOrigin = 'https://review-booking-system.onrender.com';
  try {
    bookingApiOrigin = new URL(rawBookingApiUrl).origin;
  } catch (e) {
  ...
  if (hasAnalyticsConsent) {
    ...
    cspDirectives.push(`connect-src 'self' ${apiUrl} ${bookingApiOrigin} https://res.cloudinary.com https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net`);
  } else {
    ...
    cspDirectives.push(`connect-src 'self' ${apiUrl} ${bookingApiOrigin} https://res.cloudinary.com`);
  }
